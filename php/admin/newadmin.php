...
$orders_list1 = "SELECT email FROM `admin` WHERE email='$u_email'";
$e_check = mysqli_query($con,$orders_list1);
...
$orders_list2 = "INSERT INTO admin (firstName,lastName,email,mobile,address,password,type) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]','$_POST[admintype]')";
$result = mysqli_query($con,$orders_list2);
		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><a href="newadmin.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #003366;border-radius: 12px;">New Admin</a></th>
