...
<script src="/js/homeslideshow.js"></script>
	...
	<body style="min-width: 980px; background-image: url(../image/bg4.jpg);">
...
if ($user!="") {
		...
		<div class="categolis">
			<table>
				<tr>
					<th>
						<a href="index.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #003366;border-radius: 12px;">Home</a>
					</th>
