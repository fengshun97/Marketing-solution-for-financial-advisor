...
<th><a href="Videos.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #003366;border-radius: 12px;">Videos</a>
</th>
				
<th>
<a href="Documents.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #0059b3;border-radius: 12px;">Documents</a>
</th>
...
$orders_list1 = "SELECT * FROM products WHERE available >='1' AND item ='videos'  ORDER BY id DESC LIMIT 10";	
$getposts = mysqli_query($con,$orders_list1) or die(mysqli_error($con));
...
<span style="font-size: 15px;">'.$pName.'</span><br> Price:RM '.$price.' </div>
