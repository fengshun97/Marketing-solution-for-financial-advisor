...
?>
	...
	<div class="categolis">
		<table>
			<tr>
				<th><a href="category/Videos.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #003366;border-radius: 12px;">Videos</a></th>
				<th><a href="category/Documents.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #003366;border-radius: 12px;">Documents</a></th>
				</tr>
		</table>
	</div>
					...
					<div>
						<div>
							<table class="rightsidemenu">
								<tr style="font-weight: bold;" colspan="8" bgcolor="#3A5487">
									<th>Product Name</th>
									<th>Price</th>
									<th>Total Product</th>
									<th>Order Date</th>
								...
								<tr>
									...
									<th><?php if ($item=="videos") {
												echo '<div class="home-prodlist-img"><a href="category/view_product.php?pid='.$pId.'">
													<img src="image/product/'.$item.'/video-icon.png" class="home-prodlist-imgi" style="height: 75px; width: 75px;">
													</a>
												</div>';
												}
												elseif($item=="documents"){
												echo '<div class="home-prodlist-img"><a href="category/view_product.php?pid='.$pId.'">
													<img src="image/product/'.$item.'/pdf-icon.png" class="home-prodlist-imgi" style="height: 75px; width: 75px;">
													</a>
												</div>';
												}
												else{
