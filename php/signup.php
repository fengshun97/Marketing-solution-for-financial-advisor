...
$orders_list = "SELECT email FROM `user` WHERE email='$u_email'";
$e_check = mysqli_query($con,$orders_list);
...
You are successfully created an account from Financial Planner.
...
//if (@mail($_POST['email'],"Financial Planner",$msg, "From:Financial Planner <no-reply@Financial Planner.xyz>")) {
	
$orders_list1 = "INSERT INTO user (firstName,lastName,email,mobile,address,password) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]')";					
