...
$orders_list = 	"SELECT * FROM user WHERE (email='$user_login') AND password='$password_login_md5'";
...
$orders_list1 = "SELECT * FROM user WHERE (email='$user_login') AND password='$password_login_md5'";
$result1 = mysqli_query($con,$orders_list1);
...
$orders_list2 = "SELECT * FROM user WHERE (email='$user_login') AND confirmCode='$user_acccode'";
$result2 = mysqli_query($con,$orders_list2);
